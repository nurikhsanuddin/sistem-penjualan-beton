...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white bg-red">
	<div class="container-fluid">
		<a href="<?= base_url() ?>" class="navbar-brand text-white">
			<!-- <i class="fas fa-store "></i> -->
			<span class="brand-text font-weight-bolder text-white fw-bolder">
			...
			<li class="nav-item">
				...
				<?php } else { ?>
					<a class="nav-link" data-toggle="dropdown" href="#">
						<span class="brand-text font-weight-bold text-white"><?= $this->session->userdata('nama_pelanggan')  ?></span>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>WA : 085156815391</p>
				<p>EMAIL : admin@projectmaster.cloud</p>
			</div>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="">SCS</a></li>
