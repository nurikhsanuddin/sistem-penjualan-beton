...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="d-block w-100" src="<?= base_url() ?>assets/slider/slider1.png" style="max-height: 700px;">
		</div>
		<div class="carousel-item">
			<img class="d-block w-100" src="<?= base_url() ?>assets/slider/slider2.png" style="max-height: 700px;">
		</div>
		<!-- <div class="carousel-item">
			<img class="d-block w-100" src="<?= base_url() ?>assets/slider/slider3.jpg" style="max-height: 250px;">
		</div>
		<div class="carousel-item">
			<img class="d-block w-100" src="<?= base_url() ?>assets/slider/slider4.jpg" style="max-height: 250px;">
		</div> -->
	</div>
